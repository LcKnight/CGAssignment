...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        description="Batch render every scene directory grouped by spp rounds."
    )
    parser.add_argument("exe_path", type=Path, help="Path to PathTracer.exe")
    parser.add_argument(
        "--scenes-root",
        type=Path,
...
def main() -> int:
    ...
    for spp in spp_values:
        print(f"=== Starting spp round: {spp} ===")
